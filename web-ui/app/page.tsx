...
export default function SpectatorPage() {
  const { isConnected, gameState, winRateHistory, candidates, explanation } = useGameState();
            ...
            <>
              ...
              <div className="flex-1 grid grid-cols-2 gap-8 px-8 py-4 max-w-6xl mx-auto w-full items-start min-h-0 overflow-y-auto">
                <div className="flex flex-col gap-2">
                  ...
                  <BroadcastCandidateList candidates={p1Candidates} color="red" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <BroadcastCandidateList candidates={p2Candidates} color="blue" />
                </div>
              </div>
            </>
          )}
